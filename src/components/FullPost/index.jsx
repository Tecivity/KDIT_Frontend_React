...
const FullPost = ({ post, id }) => {
	...
	//Contexts
	const { user, userInfo } = useContext(SessionApi);
										...
										<div className="content">
											<div className="reportPane">
												...
												>
													...
													nisits by reporting things
													that break the rules. Let us
												...
												<div>
													<label htmlFor="">
														...
														<b>Harassment</b> :
														Harassing, bullying,
														intimidating, or abusing
														an individual or group
														of people with the
														result of discouraging
												...
												<div>
													<label htmlFor="">
														...
														: Content posted to
														Reddit that infringes a
														copyright you own or
														control. (Note: Only the
												...
												<div>
													<label htmlFor="">
														...
														: Content posted to
														Reddit that infringes a
														trademark you own or
														control. (Note: Only the
														trademark owner or an
														authorized
														representative can
														submit a report.)
														<span class="checkmark"></span>
