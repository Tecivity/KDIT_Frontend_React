...
const HelpPage = () => {
	...
	const FAQ = [
		...
		},
		{
			...
			answer:
				'&#8226 You can format the post but not the comment. By using the provided editor you can customize your post with a wide range of options and look. Our editor which we provide is quite straight forward so you should figure it out in no time! Visit answer in the detail section to learn more information.',
			fullAnswer:
